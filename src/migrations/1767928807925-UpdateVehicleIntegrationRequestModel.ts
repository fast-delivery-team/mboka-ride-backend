...
export class UpdateVehicleIntegrationRequestModel1767928807925 implements MigrationInterface {
    name = 'UpdateVehicleIntegrationRequestModel1767928807925'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vehicle_integration_request" DROP CONSTRAINT "UQ_32416fa369fcaff49b760ff07db"`);
